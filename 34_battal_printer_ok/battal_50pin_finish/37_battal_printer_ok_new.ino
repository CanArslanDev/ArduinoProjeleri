...
#define NUM_LEDS 20
Adafruit_NeoPixel strip = Adafruit_NeoPixel(numLeds, ledPin, NEO_BRG + NEO_KHZ800); //grb , rgb,brg
...
#define N_PIXELS  18  // Number of pixels in strand
...
#define NOISE     360  // Noise/hum/interference in mic signal
#define SAMPLES   40  // Length of buffer for dynamic level adjustment
#define TOP       (N_PIXELS + 2) // (default 2) Allow dot to go slightly off scale
